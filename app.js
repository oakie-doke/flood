...
class FloodRiskApp {
    ...
    initializeMap() {
        ...
        // Disable zoom controls and layer control
        this.map = L.map('map', {
    ...
    async calculateFloodRisk(elevation, rainfall, lat, lng) {
        ...
        if (elevation < 3) {
            riskFactors.elevation = 15; // Very high risk - very low elevation, could be flooded by an increase in sea level
            ...
            riskFactors.elevation = 4;  // Medium-high risk
        } else if (elevation < 100) {
            riskFactors.elevation = 2;  // Medium risk
        } else if (elevation < 200) {
            riskFactors.elevation = 1;  // Low-medium risk
        } else {
        ...
        if (rainfall > 200) {
            riskFactors.rainfall = 15; // Very high risk - extreme rainfall
        } else if (rainfall > 100) {
            riskFactors.rainfall = 10;  // High risk - heavy rainfall
        } else if (rainfall > 50) {
            riskFactors.rainfall = 8;  // Medium-high risk in low elevation areas
        } else if (rainfall > 25) {
            riskFactors.rainfall = 4;  // Medium risk in low elevation areas
        } else if (rainfall > 10) {
            riskFactors.rainfall = 2;  // Low risk in low elevation areas
        } else {
        ...
        else if (totalRiskScore >= 8) riskLevel = 'high';
        else if (totalRiskScore >= 6) riskLevel = 'medium';
        else riskLevel = 'low';
